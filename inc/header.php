    ...
    <header>
        <nav class="navbar navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="./img/dog_13463 (1).png" alt="dog logo"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="signedinusers.php">Signed In Users</a></li>
                        <li class="nav-item"><a class="nav-link" href="view-database.php">View Customers</a></li>
                    </ul>
                </div>
            </div>
        </nav>
